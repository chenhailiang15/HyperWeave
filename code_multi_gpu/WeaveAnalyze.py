...
class args_chl:
    ...
    def init_with_default(self):
        ...
        #同步参数
        self.max_sync_num=1
        self.shm_name_list=["QigB3wOuRH0q2Khe"]
...
def analyze_one_task(model_name, batch_size, parrallel_num):
...
if __name__=="__main__":
    ...
    batch_size=16
    parrallel_num=2
    result=analyze_one_task(model_name, batch_size, parrallel_num)
